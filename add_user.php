          ...
          <div class="card " >
            ...
            <div class="card-body">
                ...
                <div class="col-lg-12">
                  ...
                  if($type == "update"){
                    ?>
                    <form id="add_dept" method="post" action="update_process.php?type=user&userid=<?php echo $id ?>">
                    <?php
                  }
                  else{
                    ?>
                    <form id="add_dept" method="post" action="add_process.php?type=user">
                    <?php
                  }
                  ?>
                    <?php
                    if($type == "update"){
                      $update = "SELECT * FROM user WHERE user_id = '".$id."'";
                    ...
                    <div class="form-group">
                      ...
                      <input type="tel" id="user_phone" name="user_phone" class="form-control" placeholder="Phone No (without -)" value="<?php echo $user_phone ?>" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" maxlength="15" pattern="[0-9]{10,11}" required>
                    </div>
